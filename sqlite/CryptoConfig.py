...
# generates an encryption key by hasing a fixed password and salt, stored in a code file
...
class CryptoConfig():
    ...
    def __init__(self, debug=False):
        self.debug = debug
        bypassword = PasswordStore.password.encode('utf-8')   # Convert to bytes
        bysalt = PasswordStore.salt.encode('utf-8')           # recommend: use a key from os.urandom(16), of type bytes
    ...
    def decrypt_json (self, payload):    
        print (payload)
        payload =  b'deliberate_tampering'
        print (payload)
        print ('decrypting...')
...
if (__name__ == '__main__'):
    jmessage = {"name" : "raja", "age":45, "city": "Coimbatore"} 
