...
#define  RELAY_ACTIVE_LOW        1            // 1 if relays are active low; 0 for active high 
#define  PRIMARY_RELAY           1            // the main light for automatic control is 0,1,2... NUM_RELAYS
...
#define  APP_NAME                "Portico Lights"  // this is only for display
...
#define  PRIMARY_LIGHT_CORRECTION    80   // when primary light is ON, it contributes this much light to the LDR
