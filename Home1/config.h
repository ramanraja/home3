...
int check_interval = 10000;  // check status once in 10 sec  (for leaky bucket)
...
void sync_time();  // TODO: implement these
void set_time (short hour, short min);
